...
;(function() {
  ...
  $(".click-phone").click(function() {
    $(this).replaceWith("934 423 4577");
    $.get("mail/emailphone.php?mode=phone");
  });
  $(".click-email").click(function() {
    $(this).replaceWith("kbhatnagar75" + decodeURIComponent("%40") + "gmail.com");
  ...
  $(".btn-hire").click(function () {
    swal({
      title: 'If you know the hire code, please enter.',
      input: 'text',
      type: 'question',
      showCancelButton: true,
      confirmButtonText: 'Hire Me',
      ...
      if (result == "HIREME") {
        swal({
          type: 'success',
          text: 'Taking you to my prices.',
          confirmButtonText: 'Show Prices',
          timer: 500
        }).then(function() {
          document.activeElement.blur();
          $("#pricing-table").prop("hidden", false);
          $('html, body').animate({
            scrollTop: $("#pricing-table").offset().top - 10
          }, 500);
        }, function () {
          document.activeElement.blur();
          $("#pricing-table").prop("hidden", false);
        ...
        swal({
          type: 'error',
          text: 'Oops. Wrong Code. Taking you to my contact information.',
          timer: 500
        }).then(function() {
          document.activeElement.blur();
          $('html, body').animate({
  ...
  // Console
  console.log("%cHey Developer! Welcome to my website! I am Kanika. Nice to meet you!", "background: #f90; color: #333; line-height: 25px; padding: 5px 10px;");
  // Portfolio Show More
  $("#portfolio-wrapper.compressed a.uncompress").click(function (e) {
    e.preventDefault();
    $("#portfolio-wrapper").animate({
      "height": $("#portfolio-gallery").height()
    }, 1000, function () {
      $(this).removeClass("compressed").removeAttr("style");
    });
    $(this).fadeOut(500);
  });
})(jQuery);
